...
class FormFieldsController extends Controller {
    ...
    public function __construct(FormFieldsInterface $formFields, SessionYearsTrackingsService $sessionYearsTrackingsService, CachingService $cache) {
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            $this->sessionYearsTrackingsService->storeSessionYearsTracking('App\Models\FormFields', $formField->id, Auth::user()->id, $sessionYear->id, Auth::user()->school_id, null);
    ...
    public function destroy($id) {
        ...
        try {
            ...
            $sessionYear = $this->cache->getDefaultSessionYear();
            $this->sessionYearsTrackingsService->deleteSessionYearsTracking('App\Models\FormFields', $id, Auth::user()->id, $sessionYear->id, Auth::user()->school_id, null);
