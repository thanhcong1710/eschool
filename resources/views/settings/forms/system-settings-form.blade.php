    ...
    <div class="row my-4 mx-1">
        ...
        <div class="form-group col-md-6 col-lg-6 col-xl-4 col-sm-12">
            ...
            <div class="input-group col-xs-12">
                ...
                <div class="col-md-12 mt-2">
                    <img height="200px" width="200px" src='{{ !empty($settings['login_page_logo']) ? url($settings['login_page_logo']) : asset('assets/no_image_available.jpg') }}' alt="Login Page Logo" class="">
                </div>
            </div>
        </div>
