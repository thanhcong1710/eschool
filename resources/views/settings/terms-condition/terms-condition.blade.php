      ...
      <div class="card">
        <div class="card-body">
          ...
          <ul class="nav nav-tabs" id="termsConditionTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="school-terms-condition-tab" data-bs-toggle="tab" href="#school-terms-condition" role="tab" aria-controls="school-terms-condition" aria-selected="false">{{ __('School Terms Condition') }}</a>
            </li>
          </ul>
          ...
          <div class="tab-content" id="termsConditionTabsContent">
            ...
            <div class="tab-pane fade py-4" id="school-terms-condition" role="tabpanel" aria-labelledby="school-terms-condition-tab">
              <div class="mt-3">
                <h5>{{ __('School Terms Condition') }}</h5>
                <div class="mb-3 d-flex mt-4">
                  {{ __("Public URL") }} :&nbsp;&nbsp;<a href="{{ route('public.school-terms-conditions') }}" target="_blank">{{ route('public.school-terms-conditions') }}</a>
                </div>
                <form id="formdata" class="setting-form" action="{{ route('system-settings.update', 1) }}" method="POST" novalidate="novalidate">
                  @csrf
                  <div class="row">
                    ...
                    <label for="data"></label>
                    <div class="form-group col-md-12 col-sm-12">
                      <textarea id="tinymce_message" name="data" required placeholder="{{ __('school_terms_condition') }}">{{ $school_terms_condition_data ?? '' }}</textarea>
                    </div>
                  </div>
                  <input class="btn btn-theme float-right" type="submit" value="{{ __('submit') }}">
                </form>
